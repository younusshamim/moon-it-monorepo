    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Update the branch details and contact information.</SheetDescription>
        </SheetHeader>
        ...
        >
          <FieldGroup className="flex-1 overflow-y-auto px-4">
            <Field data-invalid={errors.code ? true : undefined}>
              <FieldLabel htmlFor="editCode">Branch Code</FieldLabel>
              <Input id="editCode" placeholder="e.g. DHK-01" {...register("code")} />
              <FieldError errors={[errors.code]} />
            </Field>

            <Field data-invalid={errors.name ? true : undefined}>
              <FieldLabel htmlFor="editName">Branch Name</FieldLabel>
              <Input id="editName" placeholder="e.g. Dhaka Main" {...register("name")} />
              <FieldError errors={[errors.name]} />
            </Field>

            <Field data-invalid={errors.addressLine1 ? true : undefined}>
              <FieldLabel htmlFor="editAddressLine1">
                Address Line 1{" "}
            ...
            <Field data-invalid={errors.addressLine2 ? true : undefined}>
              <FieldLabel htmlFor="editAddressLine2">
                Address Line 2{" "}
                <span className="font-normal text-muted-foreground text-sm">(optional)</span>
              </FieldLabel>
              <Input
            ...
            <Field data-invalid={errors.city ? true : undefined}>
              <FieldLabel htmlFor="editCity">
                City <span className="font-normal text-muted-foreground text-sm">(optional)</span>
              </FieldLabel>
              <Input id="editCity" placeholder="e.g. Dhaka" {...register("city")} />
              <FieldError errors={[errors.city]} />
            </Field>

            <Field data-invalid={errors.phone ? true : undefined}>
              <FieldLabel htmlFor="editPhone">
                Phone <span className="font-normal text-muted-foreground text-sm">(optional)</span>
              </FieldLabel>
              <Input
                id="editPhone"
                type="tel"
            ...
            <Field data-invalid={errors.email ? true : undefined}>
              <FieldLabel htmlFor="editEmail">
                Email <span className="font-normal text-muted-foreground text-sm">(optional)</span>
              </FieldLabel>
              <Input
                id="editEmail"
                type="email"
