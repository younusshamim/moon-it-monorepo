...
// (service throws 403). `PUT /roles/:id/permissions` replaces the grant set. Gated by `role.read`/`role.manage`.
import { PERMISSIONS, type Permission, type Role } from "@moonit/schema";
import {
  Body,
  Controller,
  Delete,
